let navbar1 = $("#navbar")
  .append(` <div class="navbar colorNav navbar-dark container-fluid">
         ...
         <a href="#formulario"  class= "btn btn-dark addToCart"> Contactanos! </a>
  </div>`);
...
<div class="row ">
    <div class="col-md-12 ">
        <div class="well well-sm">
            <form action="https://formsubmit.co/eduardocila11@gmail.com" class="form-horizontal" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input id="fname" name="name" type="text" placeholder="Nombre" aria-label="nombre" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
